...
public class MarsRoverImpl implements MarsRover {
	...
	public Position move(String command) {
		...
		// check if map not null and if next position is not the position of an
		// obstacle, if it's not : move to next
	...
	public void fireLaser(Position position, int portee) {
